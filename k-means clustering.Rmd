...
Purpose of exercise is to segment the customers of a mall using their annual income and spending score (scale from 1-100), using k-means clustering method. The optimal number of clusters (k) is explored with the Elbow, average Silhouetter and Gap statistic methods. Data source: Kaggle dataset (<https://www.kaggle.com/vjchoudhary7/customer-segmentation-tutorial-in-python/activity>).
