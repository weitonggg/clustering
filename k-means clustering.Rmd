...
The optimal number of clusters (k) is explored with the Elbow, average Silhouetter and Gap statistic methods. Data source: Kaggle dataset (<https://www.kaggle.com/vjchoudhary7/customer-segmentation-tutorial-in-python/activity>).
